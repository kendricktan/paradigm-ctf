...
# RPC_URL = os.getenv("RPC_URL", "http://192.168.1.41:8545")
RPC_URL = os.getenv("RPC_URL", "http://192.168.1.100:8544")
...
def launch_hardhat() -> NodeInfo:
    ...
    node_info = NodeInfo(
        port=port, mnemonic=HARDHAT_MNEMONIC, proc=proc, uuid=uuid)
